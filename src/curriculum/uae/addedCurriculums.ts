...
export const phy11AdvBridge1: Curriculum = {
  isEnglish: false,
  units: [
    {
      id: 1,
      name: 'الوحدة الأولى: نظرة عامة على علم الفيزياء',
      icon: '🔬',
      color: 'from-slate-500 to-gray-700',
      description: 'مقدمة في علم الفيزياء، الصيغة العلمية للأرقام، الوحدات والقياس، والمتجهات وعملياتها.',
      lessons: [
        {
          id: 1,
          title: 'الجزء الأول: علم الفيزياء والصيغة العلمية للأرقام',
          icon: '📏',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.1/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'الفيزياء هي العلم الذي يدرس المادة والطاقة والتفاعل بينهما. يعتمد هذا العلم على القياس الدقيق واستخدام الرياضيات كأداة أساسية للتعبير عن الظواهر الطبيعية.',
            sections: [
              { title: 'تعريف علم الفيزياء', type: 'text', content: 'الفيزياء هي فرع من فروع العلوم الطبيعية يهتم بفهم وتفسير سلوك الكون المادي.' },
              { title: 'الصيغة العلمية للأرقام', type: 'formula', content: 'A × 10ⁿ (حيث 1 ≤ |A| < 10 و n عدد صحيح)' },
              { title: 'أهمية الصيغة العلمية', type: 'bullets', content: [
                'تسهيل كتابة الأعداد الكبيرة جداً والأعداد الصغيرة جداً',
                'تسهيل إجراء العمليات الحسابية مثل الضرب والقسمة والجمع والطرح',
                'تحديد رتبة المقدار للأرقام بدقة'
              ]},
              { title: 'أمثلة توضيحية', type: 'bullets', content: [
                'سرعة الضوء: 300,000,000 m/s تكتب كـ 3.0 × 10⁸ m/s',
                'شحنة الإلكترون: 0.00000000000000000016 C تكتب كـ 1.6 × 10⁻¹⁹ C'
              ]}
            ]
          }
        },
        {
          id: 2,
          title: 'الجزء الثاني: الوحدات والقياس',
          icon: '⚖️',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.2/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'القياس هو مقارنة كمية مجهولة بأخرى معيارية لمعرفة عدد مرات احتوائها عليها. نستخدم النظام الدولي للوحدات (SI) لضمان اتساق القياسات عالمياً.',
            sections: [
              { title: 'الوحدات الأساسية في النظام الدولي (SI)', type: 'bullets', content: [
                ...
                'شدة الإضاءة: القنديلة (cd)'
              ]},
              { title: 'الوحدات المشتقة', type: 'text', content: 'هي وحدات يتم التعبير عنها بدمج الوحدات الأساسية، مثل السرعة (m/s) والقوة (N = kg·m/s²).' },
              { title: 'أخطاء القياس وشروط الدقة', type: 'bullets', content: [
                'الدقة (Precision): مدى توافق القياسات المختلفة لنفس الكمية مع بعضها البعض',
                'الضبط (Accuracy): مدى قرب القيمة المقاسة من القيمة الحقيقية أو المقبولة',
                'أخطاء القياس: قد تكون ناجمة عن أداة القياس (صفر الأداة)، أو طريقة القياس (زاوية النظر)'
              ]}
            ]
          }
        },
        {
          id: 3,
          title: 'الجزء الثالث: المتجهات وعملياتها',
          icon: '↗️',
          duration: '60 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.3/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-1.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'تنقسم الكميات الفيزيائية إلى كميات قياسية تحدد بالمقدار فقط، وكميات متجهة تحدد بالمقدار والاتجاه معاً. تُعد المتجهات ضرورية لوصف القوى والإزاحة والسرعة المتجهة.',
            sections: [
              { title: 'الكمية القياسية والمتجهة', type: 'bullets', content: [
                'كمية قياسية (Scalar): المسافة، الكتلة، الزمن، درجة الحرارة (لا تحتاج لاتجاه)',
                'كمية متجهة (Vector): الإزاحة، السرعة المتجهة، التسارع، القوة (تحتاج لمقدار واتجاه)'
              ]},
              { title: 'تحليل المتجه', type: 'formula', content: 'Ax = A cos(θ) , Ay = A sin(θ)' },
              { title: 'محصلة متجهين متعامدين', type: 'formula', content: 'R = √(Rx² + Ry²)' },
              { title: 'اتجاه المحصلة', type: 'formula', content: 'θ = tan⁻¹(Ry / Rx)' },
              { title: 'قانون جيب التمام (المتجهات غير المتعادمة)', type: 'formula', content: 'R² = A² + B² - 2AB cos(θ)' }
            ]
          }
        }
      ]
    },
    {
      ...
      icon: '🏃',
      color: 'from-blue-500 to-cyan-600',
      description: 'تصوير الحركة، تحديد الموقع والزمن، ورسم واستخدام منحنى الموقع-الزمن لحساب السرعة المتجهة.',
      lessons: [
        {
          id: 4,
          title: 'الدرس الأول: تصوير الحركة',
          icon: '📸',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.1/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'تصوير الحركة هو تمثيل مرئي يعرض لقطات متتابعة لحركة جسم في فترات زمنية متساوية، مما يساعد على تتبع مساره وتحديد ما إذا كان يتسارع أو يتباطأ.',
            sections: [
              { title: 'مخطط الحركة (Motion Diagram)', type: 'text', content: 'سلسلة من الصور المتتابعة تظهر مواقع جسم متحرك في فترات زمنية متساوية.' },
              { title: 'نموذج الجسيم النقطي (Particle Model)', type: 'text', content: 'تبسيط مخطط الحركة باستبدال صور الجسم بنقاط مفردة متتالية عند مركزه.' },
              { title: 'تحديد أنماط الحركة', type: 'bullets', content: [
                'مسافات متساوية بين النقاط: سرعة ثابتة',
                'مسافات تزداد تدريجياً: حركة متسارعة (زيادة السرعة)',
                'مسافات تقل تدريجياً: حركة متباطئة (نقصان السرعة)'
              ]}
            ]
          }
        },
        {
          id: 5,
          title: 'الدرس الثاني: الموقع والزمن',
          icon: '📍',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.2/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'لتحديد موقع جسم متحرك بدقة، يجب اختيار نظام إحداثيات يحتوي على نقطة أصل محددة ومحاور توضح اتجاه الحركة الإيجابي والسلبي.',
            sections: [
              { title: 'نظام الإحداثيات (Coordinate System)', type: 'text', content: 'النظام الذي يعين نقطة الأصل والاتجاه الذي تزداد فيه قيم المتغيرات.' },
              { title: 'نقطة الأصل (Origin)', type: 'text', content: 'النقطة التي تكون عندها قيمة كل من المتغيرين (الموقع والزمن) صفراً.' },
              { title: 'المسافة والإزاحة', type: 'bullets', content: [
                'المسافة (Distance): طول المسار الفعلي الذي يقطعه الجسم (كمية قياسية)',
                'الإزاحة (Displacement): التغير في موقع الجسم في اتجاه معين: Δx = x_f - x_i (كمية متجهة)'
              ]},
              { title: 'الفترة الزمنية', type: 'formula', content: 'Δt = t_f - t_i' }
            ]
          }
        },
        {
          id: 6,
          title: 'الدرس الثالث: منحنى (الموقع-الزمن)',
          icon: '📈',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.3/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'منحنى (الموقع-الزمن) هو أداة بيانية نمثل فيها الزمن على المحور الأفقي والموقع على المحور الرأسي، ويُستخدم لتحديد موقع الجسم عند أي زمن وميل الخط يمثل السرعة.',
            sections: [
              { title: 'رسم المنحنى البياني', type: 'bullets', content: [
                'المحور السيني (x-axis): يمثل الزمن (t) بالثواني',
                'المحور الصادي (y-axis): يمثل الموقع (x) بالأمتار'
              ]},
              { title: 'ميل منحنى (الموقع-الزمن)', type: 'text', content: 'ميل الخط المستقيم في المنحنى يمثل السرعة المتجهة المتوسطة للجسم.' },
              { title: 'تفسير التقاطعات', type: 'bullets', content: [
                'نقطة تقاطع المنحنى مع المحور الصادي تمثل موقع الجسم الابتدائي عند t = 0',
                'تقاطع منحنيين لجسمين يمثل وقت ومكان التقائهما'
              ]}
            ]
          }
        },
        {
          id: 7,
          title: 'الدرس الرابع: السرعة المتجهة',
          icon: '🚗',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.4/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-2.4-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'السرعة المتجهة المتوسطة هي معدل التغير في الموقع بالنسبة للزمن، بينما السرعة القياسية المتوسطة هي مقدار السرعة دون اعتبار للاتجاه.',
            sections: [
              { title: 'السرعة المتجهة المتوسطة (Average Velocity)', type: 'formula', content: 'v_avg = Δx / Δt = (x_f - x_i) / (t_f - t_i)' },
              { title: 'السرعة القياسية المتوسطة (Average Speed)', type: 'text', content: 'المسافة الكلية المقطوعة مقسومة على الفترة الزمنية المستغرقة.' },
              { title: 'السرعة المتجهة اللحظية (Instantaneous Velocity)', type: 'text', content: 'سرعة الجسم المتجهة عند لحظة زمنية معينة وتساوي ميل مماس منحنى (الموقع-الزمن) عند تلك اللحظة.' },
              { title: 'معادلة الحركة للموقع', type: 'formula', content: 'x = v·t + x_i' }
            ]
          }
        }
      ]
    ...
    {
      id: 3,
      name: 'الوحدة الثالثة: الحركة المتسارعة',
      icon: '⚡',
      color: 'from-orange-500 to-red-600',
      description: 'دراسة التسارع، معادلات الحركة بتسارع ثابت، وتحليل حركة السقوط الحر للأجسام تحت تأثير الجاذبية.',
      lessons: [
        {
          id: 8,
          title: 'الدرس الأول: التسارع',
          icon: '📈',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.1/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'التسارع هو معدل تغير السرعة المتجهة بالنسبة للزمن. يحدث التسارع عندما تتغير سرعة الجسم أو اتجاه حركته أو كلاهما معاً.',
            sections: [
              { title: 'التسارع المتوسط (Average Acceleration)', type: 'formula', content: 'a_avg = Δv / Δt = (v_f - v_i) / (t_f - t_i)' },
              { title: 'وحدة قياس التسارع', type: 'formula', content: 'متر لكل ثانية مربعة (m/s²)' },
              { title: 'إشارات التسارع وحالة الحركة', type: 'bullets', content: [
                'التسارع والسرعة في نفس الاتجاه: تزداد سرعة الجسم (تسارع)',
                'التسارع والسرعة في اتجاهين متعاكسين: تقل سرعة الجسم (تباطؤ)',
                'التسارع اللحظي (Instantaneous Acceleration): تغير السرعة عند لحظة زمنية محددة ويساوي ميل مماس منحنى (السرعة-الزمن)'
              ]}
            ]
          }
        },
        {
          id: 9,
          title: 'الدرس الثاني: الحركة بتسارع ثابت',
          icon: '📏',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.2/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'عندما يتحرك جسم بتسارع ثابت، يمكننا استخدام معادلات الحركة لربط السرعة والموقع والتسارع والزمن دون الحاجة لتتبع الحركة خطوة بخطوة.',
            sections: [
              { title: 'معادلة الحركة الأولى (السرعة والزمن)', type: 'formula', content: 'v_f = v_i + a·t' },
              { title: 'معادلة الحركة الثانية (الموقع والزمن)', type: 'formula', content: 'x_f = x_i + v_i·t + ½·a·t²' },
              { title: 'معادلة الحركة الثالثة (السرعة والموقع)', type: 'formula', content: 'v_f² = v_i² + 2·a·(x_f - x_i)' },
              { title: 'خطوات حل المسائل بتسارع ثابت', type: 'bullets', content: [
                '1. حدد المعطيات بدقة مع الانتباه للإشارات',
                '2. اختر المعادلة المناسبة التي تحوي المجهول وثلاثة معطيات',
                '3. عوض القيم وحل المعادلة رياضياً وتحقق من منطقية الناتج'
              ]}
            ]
          }
        },
        {
          id: 10,
          title: 'الدرس الثالث: السقوط الحر',
          icon: '🪂',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.3/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-3.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'السقوط الحر هو حركة جسم تحت تأثير قوة الجاذبية الأرضية فقط، مع إهمال مقاومة الهواء. تتحرك جميع الأجسام الساقطة سقوطاً حراً بالتسارع نفسه.',
            sections: [
              { title: 'تسارع الجاذبية الأرضية (g)', type: 'formula', content: 'g = 9.8 m/s² (في اتجاه مركز الأرض)' },
              { title: 'تعديل معادلات الحركة للسقوط الحر', type: 'bullets', content: [
                'نستبدل التسارع a بالقيم -g (إذا اعتبرنا الاتجاه لأعلى موجباً)',
                'v_f = v_i - g·t',
                'y_f = y_i + v_i·t - ½·g·t²',
                'v_f² = v_i² - 2·g·(y_f - y_i)'
              ]},
              { title: 'حقائق حول المقذوفات الرأسية', type: 'bullets', content: [
                'عند أقصى ارتفاع: السرعة اللحظية تساوي صفراً (v_f = 0)',
                'زمن الصعود يساوي زمن الهبوط لنفس المستوى',
                'سرعة الجسم عند عودته لنفس نقطة الإطلاق تساوي سرعة إطلاقه بالمقدار وتعاكسها بالإشارة'
              ]}
            ]
          }
        }
    ...
    },
    {
      ...
      description: 'دراسة مسببات الحركة، قوانين نيوتن الثلاثة، مخطط الجسم الحر، وحساب قوى الاحتكاك والشد والوزن الظاهري.',
      lessons: [
        {
          id: 11,
          title: 'الدرس الأول: القوة والحركة',
          icon: '🛡️',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.1/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'القوة هي مؤثر خارجي يغير أو يحاول تغيير حالة الجسم الحركية أو شكله. تُقاس القوة بوحدة النيوتن وتحدد بالمقدار والاتجاه.',
            sections: [
              { title: 'أنواع القوى', type: 'bullets', content: [
                'قوى تلامس (Contact Forces): تنشأ عن تلامس مباشر بين الأجسام (الاحتكاك، الدفع)',
                'قوى مجال (Field Forces): تؤثر عن بعد دون تلامس (الجاذبية، الكهرومغناطيسية)'
              ]},
              { title: 'مخطط الجسم الحر (Free-Body Diagram)', type: 'text', content: 'نموذج فيزيائي يمثل القوى المؤثرة على جسم ما باستخدام متجهات مرسومة من نقطة تمثل الجسم.' },
              { title: 'القوة المحصلة (Net Force)', type: 'formula', content: 'F_net = ΣF = F₁ + F₂ + ... (الجمع الاتجاهي للقوى)' },
              { title: 'قانون نيوتن الأول (القصور الذاتي)', type: 'text', content: 'يبقى الجسم على حالته من سكون أو حركة مستقيمة بسرعة ثابتة ما لم تؤثر عليه قوة محصلة تغير حالته.' }
            ]
          }
        },
        {
          id: 12,
          title: 'الدرس الثاني: استخدام قوانين نيوتن',
          icon: '⚙️',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.2/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'يربط قانون نيوتن الثاني بين القوة المحصلة وتسارع الجسم وكتلته، ويشكل الأساس لحساب حركة الأجسام تحت تأثير قوى متعددة.',
            sections: [
              { title: 'قانون نيوتن الثاني', type: 'formula', content: 'F_net = m · a (القوة المحصلة = الكتلة × التسارع)' },
              { title: 'تعريف النيوتن (N)', type: 'formula', content: '1 N = 1 kg·m/s²' },
              { title: 'الوزن الحقيقي والوزن الظاهري', type: 'bullets', content: [
                'الوزن الحقيقي (Fg): قوة جذب الأرض للجسم: Fg = m·g',
                'الوزن الظاهري (F_apparent): القوة التي تؤثر بها موازين القراءة على الجسم (مثل قراءة الميزان داخل مصعد متسارع)',
                'مصعد يتسارع لأعلم: F_apparent = m(g + a)',
                'مصعد يتسارع لأسفل: F_apparent = m(g - a)',
                'سقوط حر للمصعد: F_apparent = 0 (انعدام الوزن)'
              ]},
              { title: 'قوة الممانعة والسرعة الحدية', type: 'bullets', content: [
                'قوة الممانعة (Drag Force): القوة التي يؤثر بها مائع على جسم يتحرك فيه وتزداد بزيادة سرعته',
                'السرعة الحدية (Terminal Velocity): السرعة الثابتة التي يصل إليها الجسم عندما تتساوى قوة الممانعة مع قوة الجاذبية'
              ]}
            ]
          }
        },
        {
          id: 13,
          title: 'الدرس الثالث: قوى التفاعل',
          icon: '🤝',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.3/',
          examUrl: 'https://hesham-afandi.github.io/11Adv-Bri-phy-T1-4.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'توجد القوى دائماً في الطبيعة على شكل أزواج متبادلة. يوضح قانون نيوتن الثالث أن لكل فعل رد فعل مساوٍ له في المقدار ومعاكس له في الاتجاه.',
            sections: [
              { title: 'قانون نيوتن الثالث', type: 'formula', content: 'F_A_on_B = -F_B_on_A' },
              { title: 'خصائص قوى الفعل ورد الفعل', type: 'bullets', content: [
                'تنشأ معاً وتختفيان معاً',
                'متساويتان في المقدار ومتعاكستان في الاتجاه',
                'تؤثران على جسمين مختلفين (لذلك لا تلغي إحداهما الأخرى)',
                'لهما نفس الطبيعة (مثلاً: قوتان مغناطيسيتان أو قوتان كهربائيتان)'
              ]},
              { title: 'قوة الشد (Tension Force)', type: 'text', content: 'القوة التي يؤثر بها حبل أو خيط مشدود على الجسم المتصل به، وتكون متساوية على طول الحبل.' },
              { title: 'القوة العمودية (Normal Force)', type: 'formula', content: 'F_N (قوة تلامس يؤثر بها سطح على جسم آخر عمودياً لمنع تداخلهما. على سطح أفقي: F_N = Fg = m·g)' }
            ]
          }
        }
      ]
...
export const math11General1: Curriculum = {
  isEnglish: false,
  units: [
    {
      id: 1,
      ...
      icon: '📐',
      color: 'from-blue-500 to-indigo-600',
      description: 'دراسة التعبيرات الجبرية، خواص الأعداد الحقيقية، حل المعادلات الخطية، معادلات ومتباينات القيمة المطلقة.',
      lessons: [
        {
          id: 1,
          title: 'الدرس الأول: التعبيرات والقواعد',
          icon: '📝',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.1/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'التعبيرات الجبرية تتكون من أرقام ومتغيرات وعمليات حسابية. القواعد الرياضية هي معادلات تعبر عن العلاقات بين كميات فيزيائية أو هندسية محددة.',
            sections: [
              { title: 'ترتيب العمليات الحسابية (PEMDAS)', type: 'bullets', content: [
                '1. الأقواس (Parentheses) أولاً',
                '2. الأسس والجذور (Exponents)',
                '3. الضرب والقسمة من اليسار إلى اليمين (Multiplication & Division)',
                '4. الجمع والطرح من اليسار إلى اليمين (Addition & Subtraction)'
              ]},
              { title: 'التعبيرات الجبرية', type: 'text', content: 'لإيجاد قيمة تعبير جبري، نستبدل المتغيرات بقيمها المعطاة ثم نطبق ترتيب العمليات الحسابية.' },
              { title: 'الصيغ الهندسية والقوانين', type: 'formula', content: 'المساحة: A = l·w , المحيط: P = 2(l + w)' }
            ]
          }
        },
        {
          id: 2,
          title: 'الدرس الثاني: خواص الأعداد الحقيقية',
          icon: '🔢',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.2/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'تتكون الأعداد الحقيقية من الأعداد النسبية وغير النسبية. تتيح لنا خواص الأعداد الحقيقية تبسيط التعبيرات الجبرية وحل المعادلات بسهولة.',
            sections: [
              { title: 'مجموعات الأعداد الحقيقية (R)', type: 'bullets', content: [
                'الأعداد الطبيعية (N): {1, 2, 3, ...}',
                'الأعداد الكلية (W): {0, 1, 2, 3, ...}',
                'الأعداد الصحيحة (Z): {..., -2, -1, 0, 1, 2, ...}',
                'الأعداد النسبية (Q): الأعداد التي يمكن كتابتها على صورة كسر a/b',
                'الأعداد غير النسبية (I): الأعداد غير الدورية والغير منتهية مثل π و √2'
              ]},
              { title: 'خواص العمليات', type: 'bullets', content: [
                'الخاصية التبديلية: a + b = b + a  و  a·b = b·a',
                'الخاصية التجميعية: (a + b) + c = a + (b + c)',
                'خاصية التوزيع: a(b + c) = ab + ac',
                'العنصر المحايد: الجمعي هو 0 والضربي هو 1',
                'النظير: الجمعي هو -a والضربي هو 1/a (لكل a ≠ 0)'
              ]}
            ]
          }
        },
        {
          id: 3,
          title: 'الدرس الثالث: حل المعادلات',
          icon: '🧮',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.3/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'المعادلة هي جملة رياضية تحتوي على علامة مساواة تفصل بين تعبيرين جبريين. حل المعادلة يعني إيجاد قيمة المتغير التي تجعل الجملة صحيحة.',
            sections: [
              { title: 'خطوات حل المعادلات الخطية', type: 'bullets', content: [
                '1. تبسيط طرفي المعادلة بفك الأقواس وتجميع الحدود المتشابهة',
                '2. عزل المتغير في أحد طرفي المعادلة باستخدام العمليات العكسية',
                '3. التحقق من صحة الحل بتعويض القيمة الناتجة في المعادلة الأصلية'
              ]},
              { title: 'صيغة المعادلة الخطية بمتغير واحد', type: 'formula', content: 'ax + b = c  (حيث a ≠ 0)' },
              { title: 'المعادلات ذات الحلول الخاصة', type: 'bullets', content: [
                'حل وحيد: مثل x = 3',
                'عدد لانهائي من الحلول (متطابقة): مثل 3x + 2 = 3x + 2',
                'لا يوجد حل (تناقض): مثل 3x + 2 = 3x + 5'
              ]}
            ]
          }
        },
        {
          id: 4,
          title: 'الدرس الرابع: حل معادلات القيمة المطلقة',
          icon: '📏',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.4/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.4-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'تمثل القيمة المطلقة مسافة الرقم عن الصفر على خط الأعداد، ولذلك فهي دائماً موجبة أو صفر. لحل معادلات القيمة المطلقة، يجب مراعاة الحالتين الموجبة والسالبة.',
            sections: [
              { title: 'تعريف القيمة المطلقة', type: 'formula', content: '|x| = x إذا كان x ≥ 0 ، و -x إذا كان x < 0' },
              { title: 'قاعدة حل معادلة القيمة المطلقة', type: 'formula', content: 'إذا كان |ax + b| = c (حيث c ≥ 0) فإن: ax + b = c  أو  ax + b = -c' },
              { title: 'الحلول الدخيلة (Extraneous Solutions)', type: 'bullets', content: [
                'عند حل معادلات تحوي قيمة مطلقة، قد تظهر حلول لا تحقق المعادلة الأصلية',
                'يجب دائماً التحقق من صحة الحلول بالتعويض المباشر في المعادلة الأصلية',
                'إذا كانت c < 0 فإن المعادلة ليس لها حل ومجموعة الحل هي Ø'
              ]}
            ]
          }
        },
        {
          id: 5,
          title: 'الدرس الخامس: حل المتباينات',
          icon: '⚠️',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.5/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.5-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'المتباينة هي جملة رياضية تحتوي على رموز مقارنة مثل (<, >, ≤, ≥). حل المتباينة يمثل مجموعة من القيم وغالباً ما يُرسم بيانيا على خط الأعداد.',
            sections: [
              { title: 'خصائص المتباينات', type: 'bullets', content: [
                'عند جمع أو طرح أي عدد من طرفي المتباينة لا يتغير اتجاه المتباينة',
                'عند ضرب أو قسمة طرفي المتباينة على عدد موجب لا يتغير اتجاهها',
                'هام جداً: عند ضرب أو قسمة طرفي المتباينة على عدد سالب يجب عكس اتجاه رمز المقارنة'
              ]},
              { title: 'رمز الفترات (Interval Notation)', type: 'bullets', content: [
                'فترة مغلقة [a, b]: تشمل الأطراف (a ≤ x ≤ b)',
                'فترة مفتوحة (a, b): لا تشمل الأطراف (a < x < b)',
                'اللانهاية (∞): نستخدم دائماً قوساً مفتوحاً معها'
              ]}
            ]
          }
        },
        {
          id: 6,
          title: 'الدرس السادس: حل المتباينات المركبة ومتباينات القيمة المطلقة',
          icon: '🔗',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.6/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-1.6-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'المتباينة المركبة تحتوي على متباينتين مربوطتين بأداة الربط "و" (AND) للتقاطع، أو أداة الربط "أو" (OR) للاتحاد. تُحل متباينات القيمة المطلقة بتحويلها إلى متباينات مركبة.',
            sections: [
              { title: 'المتباينات المركبة (AND vs OR)', type: 'bullets', content: [
                'الربط "و" (Intersection): يتطلب تحقيق الشرطين معاً، ومجموعة الحل هي منطقة التداخل بين الحلّين',
                'الربط "أو" (Union): يتطلب تحقيق أحد الشرطين على الأقل، ومجموعة الحل تشمل كلا الحلين معاً'
              ]},
              { title: 'متباينات القيمة المطلقة (أصغر من)', type: 'formula', content: 'إذا كان |ax + b| < c فإن: -c < ax + b < c (متباينة "و")' },
              { title: 'متباينات القيمة المطلقة (أكبر من)', type: 'formula', content: 'إذا كان |ax + b| > c فإن: ax + b > c  أو  ax + b < -c (متباينة "أو")' }
            ]
          }
        }
      ]
    ...
    {
      id: 2,
      name: 'الوحدة الثانية: العلاقات والدوال الخطية',
      icon: '📈',
      color: 'from-purple-500 to-pink-600',
      description: 'تمثيل العلاقات والدوال، دراسة ميل المستقيم، كتابة المعادلات الخطية، ورسم المتباينات الخطية بيانياً.',
      lessons: [
        {
          id: 7,
          title: 'الدرس الأول: العلاقات والدوال',
          icon: '📍',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.1/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'العلاقة هي ارتباط بين مجموعتين يمثلان المجال والمدى. الدالة هي علاقة خاصة يرتبط فيها كل عنصر من المجال بعنصر واحد فقط من المدى.',
            sections: [
              { title: 'المجال والمدى', type: 'bullets', content: [
                'المجال (Domain): مجموعة الإدخالات (قيم x)',
                'المدى (Range): مجموعة المخرجات (قيم y)'
              ]},
              { title: 'اختبار الخط الرأسي (Vertical Line Test)', type: 'text', content: 'إذا قطع أي خط رأسي المنحنى البياني في أكثر من نقطة واحدة، فإن العلاقة لا تمثل دالة.' },
              { title: 'أنواع الدوال', type: 'bullets', content: [
                'دالة متباينة (One-to-One): لا يرتبط فيها عنصران مختلفان من المجال بنفس المخرجة',
                'دالة متصلة (Continuous): يمكن رسم منحناها دون رفع القلم',
                'دالة منفصلة (Discrete): تتكون من نقاط منفردة غير متصلة'
              ]}
            ]
          }
        },
        {
          id: 8,
          title: 'الدرس الثاني: الدوال الخطية',
          icon: '➖',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.2/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'الدالة الخطية هي دالة يمكن كتابتها على الصورة f(x) = mx + b وتمثيلها البياني هو خط مستقيم غير رأسي. ميل هذا الخط ثابت دائماً.',
            sections: [
              { title: 'الصيغة القياسية للمعادلة الخطية', type: 'formula', content: 'Ax + By = C (حيث A, B, C أعداد صحيحة و A ≥ 0)' },
              { title: 'التقاطع مع المحاور (Intercepts)', type: 'bullets', content: [
                'التقاطع مع x (x-intercept): نضع y = 0 ونحل لـ x',
                'التقاطع مع y (y-intercept): نضع x = 0 ونحل لـ y'
              ]},
              { title: 'الدوال الثابتة', type: 'formula', content: 'f(x) = c  (تمثيلها خط أفقي ميله صفر)' }
            ]
          }
        },
        {
          id: 9,
          title: 'الدرس الثالث: معادلات المستقيم',
          icon: '📐',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.3/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'ميل المستقيم يقيس انحداره ويمثل نسبة التغير الرأسي إلى التغير الأفقي. تختلف معادلات المستقيم بناءً على المعطيات المتوفرة (نقطة وميل أو نقطتين).',
            sections: [
              { title: 'صيغة الميل (Slope Formula)', type: 'formula', content: 'm = (y₂ - y₁) / (x₂ - x₁)' },
              { title: 'صيغة الميل والمقطع', type: 'formula', content: 'y = mx + b (m هو الميل، b هو مقطع y)' },
              { title: 'صيغة الميل والنقطة', type: 'formula', content: 'y - y₁ = m(x - x₁)' },
              { title: 'المستقيمات المتوازية والمتعامدة', type: 'bullets', content: [
                'المستقيمات المتوازية: لها نفس الميل تماماً (m₁ = m₂)',
                'المستقيمات المتعامدة: ميل أحدهما هو مقلوب الآخر بعكس الإشارة (m₁ · m₂ = -1)'
              ]}
            ]
          }
        },
        {
          id: 10,
          title: 'الدرس الرابع: كتابة المعادلات الخطية',
          icon: '✍️',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.4/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.4-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'يمكننا كتابة معادلة أي خط مستقيم إذا توفر لدينا معلومات كافية مثل نقطتين يمر بهما الخط، أو نقطة واحدة مع ميله أو مستقيم موازٍ أو عمودي عليه.',
            sections: [
              { title: 'كتابة المعادلة بمعلومية نقطتين', type: 'bullets', content: [
                '1. احسب الميل m باستخدام قانون الميل',
                '2. اختر إحدى النقطتين وعوض مع الميل في صيغة الميل والنقطة',
                '3. بسط المعادلة واكتبها في الصيغة المطلوبة (الميل والمقطع أو القياسية)'
              ]},
              { title: 'تطبيقات حياتية', type: 'text', content: 'العديد من الظواهر في الفيزياء والاقتصاد تتبع نموذجاً خطياً، حيث يمثل الميل معدل التغير المباشر وتمثل نقطة التقاطع مع y القيمة الابتدائية.' }
            ]
          }
        },
        {
          id: 11,
          title: 'الدرس الخامس: متباينات خطية في متغيرين',
          icon: '⚠️',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.5/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-2.5-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'المتباينة الخطية بمتغيرين تشبه المعادلة الخطية ولكن تحوي رمز مقارنة. يمثل حلها بنصف مستوى بياني يتم تحديده باستخدام خط حد وسلسلة اختبار نقاط.',
            sections: [
              { title: 'خطوات رسم المتباينة الخطية', type: 'bullets', content: [
                '1. ارسم المستقيم الحدي للمعادلة المرافقة y = mx + b',
                '2. اجعل الخط متصلاً إذا كان الرمز (≤ أو ≥) ، ومتقطعاً إذا كان الرمز (< أو >)',
                '3. اختر نقطة اختبار لا تقع على الخط (مثل (0,0)) وعوضها في المتباينة',
                '4. ظلل المنطقة التي تحتوي على النقطة إذا كانت العبارة صحيحة، وإلا ظلل المنطقة الأخرى'
              ]}
            ]
          }
        }
    ...
    {
      id: 3,
      name: 'الوحدة الثالثة: أنظمة المعادلات والمتباينات',
      icon: '⛓️',
      color: 'from-amber-500 to-yellow-600',
      description: 'حل أنظمة المعادلات بيانياً وجبرياً (التعويض والحذف)، رسم أنظمة المتباينات، وتطبيقات البرمجة الخطية.',
      lessons: [
        {
          id: 12,
          title: 'الدرس الأول: حل أنظمة المعادلات بيانياً',
          icon: '📊',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.1/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.1-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'يتكون نظام المعادلات من معادلتين أو أكثر بمتغيرات مشتركة. حل النظام بيانياً هو إيجاد نقطة التقاطع المشتركة بين المستقيمات الممثلة للمعادلات.',
            sections: [
              { title: 'تصنيف أنظمة المعادلات الخطية', type: 'bullets', content: [
                'نظام متسق ومستقل (Consistent & Independent): يتقاطع المستقيمان في نقطة واحدة (له حل وحيد)',
                'نظام متسق وغير مستقل (Consistent & Dependent): ينطبق المستقيمان فوق بعضهما (عدد لانهائي من الحلول)',
                'نظام غير متسق (Inconsistent): يتوازى المستقيمان ولا يتقاطعان أبداً (لا يوجد حل)'
              ]}
            ]
          }
        },
        {
          id: 13,
          title: 'الدرس الثاني: حل أنظمة المعادلات جبرياً',
          icon: '🧮',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.2/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.2-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'نظراً لأن الحل البياني قد لا يكون دقيقاً دائماً، نستخدم الطرق الجبرية للحصول على حلول دقيقة تماماً. الطريقتان الأساسيتان هما التعويض والحذف.',
            sections: [
              { title: 'طريقة التعويض (Substitution)', type: 'bullets', content: [
                '1. حل إحدى المعادلتين للتعبير عن أحد المتغيرين بدلالة الآخر (مثلاً x = ...)',
                '2. عوض هذا التعبير في المعادلة الأخرى للحصول على معادلة بمتغير واحد وحلها',
                '3. عوض القيمة الناتجة في أي من المعادلتين لإيجاد قيمة المتغير الثاني'
              ]},
              { title: 'طريقة الحذف (Elimination)', type: 'bullets', content: [
                '1. اضرب إحدى المعادلتين أو كلتيهما في أعداد مناسبة لتجعل معاملات أحد المتغيرين متساوية بالمقدار ومتعاكسة بالإشارة',
                '2. اجمع المعادلتين لحذف هذا المتغير وحل المعادلة الناتجة بمتغير واحد',
                '3. عوض القيمة الناتجة لإيجاد المتغير المحذوف'
              ]}
            ]
          }
        },
        {
          id: 14,
          title: 'الدرس الثالث: أنظمة المتباينات بيانياً',
          icon: '📈',
          duration: '50 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.3/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.3-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'حل نظام من المتباينات الخطية يعني إيجاد منطقة الحل المشتركة التي تحقق جميع متباينات النظام في آن واحد. يتم ذلك بتمثيل كل متباينة وتحديد منطقة التداخل الظليلة.',
            sections: [
              { title: 'خطوات الحل المشترك بيانيا', type: 'bullets', content: [
                '1. ارسم وظلل كل متباينة في النظام على حدة بنفس مستوى الإحداثيات',
                '2. حدد المنطقة التي تداخلت فيها جميع التظليلات السابقة',
                '3. اختبر نقطة داخل منطقة التداخل للتأكد من أنها تحقق جميع متباينات النظام'
              ]}
            ]
          }
        },
        {
          id: 15,
          title: 'الدرس الرابع: البرمجة الخطية',
          icon: '🎯',
          duration: '55 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.4/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.4-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'البرمجة الخطية هي طريقة لإيجاد القيمة العظمى أو الصغرى لدالة هدف معينة تحت قيود محددة تمثلها متباينات خطية. تُستخدم بكثرة في قطاع الأعمال والإنتاج وتوزيع الموارد.',
            sections: [
              { title: 'منطقة الحلول الممكنة (Feasible Region)', type: 'text', content: 'المنطقة المشتركة الناتجة عن تمثيل متباينات القيود.' },
              { title: 'نظرية القيمة القصوى للبرمجة الخطية', type: 'bullets', content: [
                'تحدث القيمة العظمى والقيمة الصغرى لدالة الهدف دائماً عند رؤوس (Vertices) منطقة الحلول الممكنة',
                'لحل أي مسألة برمجة خطية: نحدد الرؤوس بيانيا، ثم نعوض إحداثيات كل رأس في دالة الهدف ونقارن النتائج'
              ]},
              { title: 'دالة الهدف (Objective Function)', type: 'formula', content: 'f(x, y) = ax + by' }
            ]
          }
        },
        {
          id: 16,
          title: 'الدرس الخامس: أنظمة المعادلات في ثلاثة متغيرات',
          icon: '🧊',
          duration: '60 min',
          lessonUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.5/',
          examUrl: 'https://hesham-afandi.github.io/11Jen-math-T1-3.5-exam/',
          lessonTitle: '📖 شرح الدرس',
          examTitle: '📝 اختبر نفسك',
          content: {
            intro: 'يتطلب حل نظام من ثلاث معادلات في ثلاثة متغيرات (x, y, z) استخدام التعويض أو الحذف المنظم لتقليص النظام إلى معادلتين بمتغيرين ثم حله كما تعلمنا سابقاً.',
            sections: [
              { title: 'تمثيل المعادلات ثلاثية الأبعاد', type: 'text', content: 'تمثل كل معادلة في ثلاثة متغيرات مستوياً (Plane) في الفضاء ثلاثي الأبعاد.' },
              { title: 'خطوات الحل الجبري المنظم', type: 'bullets', content: [
                '1. اختر معادلتين واحذف متغيراً واحداً منهما (مثلاً z)',
                '2. اختر معادلتين أخريين واحذف نفس المتغير z للحصول على معادلة ثانية بمتغيرين',
                '3. حل النظام الثنائي الناتج لإيجاد قيمتي المتغيرين المتبقيين (x, y)',
                '4. عوض القيمتين لإيجاد المتغير الثالث z في إحدى المعادلات الأصلية'
              ]}
            ]
          }
        }
